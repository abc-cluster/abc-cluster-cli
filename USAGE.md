...
| `--plugin`            | Pin a Nextflow plugin to a version, `id@version` (repeatable), e.g. `--plugin nf-nomad@0.4.4`. Plugins otherwise default to pinned stable releases (`nf-nomad` 0.4.4 / `nf-nomad-s5cmd` 0.1.7). | |
